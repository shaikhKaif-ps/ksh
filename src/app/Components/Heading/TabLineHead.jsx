...
//       className="pb-[20px] border-b lg:mb-[66px] mb-[36px] border-[#D7D7D7] border-opacity-[34%] overflow-hidden whitespace-nowrap max-w-[80vw] tablinehead"
//     >
//       <div className="flex items-center justify-between w-[80vw] lg:gap-0 gap-[20px]">
...
//             <button
//               onClick={() => hTabClick(btntitle.title)}
//               key={btntitle.title + " " + toString(index)}
