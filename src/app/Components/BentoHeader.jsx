    ...
    <div>
      ...
      <div className="flex md:flex-row flex-col md:gap-0 gap-[30px] items-center justify-between max-w-full">
        ...
        <div className="md:w-[50%] lg:w-[40%] w-full flex flex-col gap-[30px]">
          ...
          <div className="flex cursor-pointer group items-center gap-4 justify-between hover:translate-x-[5px] transition-transform duration-[400ms] font-semibold text-[#ffffff] text-[16px] w-fit">
            <img
